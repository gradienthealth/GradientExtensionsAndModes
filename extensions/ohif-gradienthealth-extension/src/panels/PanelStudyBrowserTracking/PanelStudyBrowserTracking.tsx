...
function PanelStudyBrowserTracking({
  ...
  const [
    { activeViewportId, viewports, isHangingProtocolLayout },
    viewportGridService,
  ] = useViewportGrid();
  ...
  }, [StudyInstanceUIDs, dataSource, getStudiesForPatientByMRN]);
  ...
  }, [thumbnailImageSrcMap, viewports, dataSource, displaySetService]);
